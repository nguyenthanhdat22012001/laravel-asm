...
<form action="{{route('get_backend.blog.update',$blog->id)}}" method="post" enctype="multipart/form-data">
@csrf
...
<div class="card card-default">
        ...
        <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="bl_name" placeholder="Nhập Tiêu Đề" value="{{ $blog->bl_name }}">
                ...
                <div class="form-group">
                    ...
                    @foreach($categoryBlogs as $item)
                        ...
                        <option value="{{$item->id}}" {{$blog->bl_categoryBlog_id == $item->id ? 'selected' : ''}} >{{$item->cbl_name}}</option>
   ...
   <div class="card card-default">
        <div class="card-body">
            ...
            <div class="col-lg-12">
                @if($blog->bl_avatar)
                    <img src="{{asset('images/news\/')}}{{$blog->bl_avatar}}" style="width:100%; height:auto" alt="">
                @endif
            </div>
        </div>
    </div>
   ...
   <div class="form-footer pt-4 pt-5 mt-4 border-top clearfix">
            ...
            <div class="float-right">
                 <label class="control control-checkbox checkbox-primary">Hiện
					<input type="checkbox" {{$blog->bl_active == 1 ? 'checked' : '' }} " name="bl_active" value="1">
