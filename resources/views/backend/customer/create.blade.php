...
<div class="card card-default">
        <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="c_name" placeholder="Enter Email" value="{{ old('c_name',) }}">
                ...
                <div class="form-group">
                    ...
                    @foreach($categories as $item)
                        ...
                        <option value="{{$item->id}}" {{old('c_parent') == $item->id ? 'selected' : ''}} >{{$item->c_name}}</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="c_description">{{ old('c_description')}}</textarea>
                </div>  
