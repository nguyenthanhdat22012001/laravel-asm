...
<table class="table">
  ...
  @foreach($accounts as $item)
    <tr>
      ...
      <td>{{$item->role}}</td>
      <td>
      <a type="button" href="{{route('get_backend.account.edit',$item->id)}}" class="mb-1 btn btn-pill btn-outline-warning"><i class="mdi mdi-grease-pencil"></i></a>
      <a type="button" href="{{route('get_backend.account.delete',$item->id)}}" class="mb-1 btn btn-pill btn-outline-danger"><i class="mdi mdi-delete"></i></a>
      </td>
    </tr>
    @endforeach
  </tbody>
