<h4>@yield('title_form') {{$brand->br_name ?? ''}}</h4>
<form action="{{$route}}" method="post" enctype="multipart/form-data">
@csrf
<div class="card card-default">
        <div class="card-body">
        <div class="form-group">
                    <label for="exampleFormControlInput1">Thương Hiệu <span style="color:red">*</span> </label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="br_name" placeholder="Nhập Thương Hiệu" value="{{ old('br_name', $brand->br_name ?? '') }}">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control-file" id="exampleFormControlFile1" name="br_avatar">
        </div>
        <div class="col-lg-12">
            @isset($brand->br_avatar)
              <img src="{{asset('images/brand\/')}}{{$brand->br_avatar}}" style="width:150px; height:auto; margin-top:20px" alt="">
            @endisset
        </div>
     </div>
    </div>
   ...
   <div class="form-footer pt-4 pt-5 mt-4 border-top clearfix">
            ...
            <div class="float-right">
                 ...
                 @if(isset($brand))
                    ...
                    <input type="checkbox" {{ $brand->br_active == 1 ? 'checked' : ''}} name="br_active" value="1">
                  @else
               
                    <input type="checkbox" checked name="br_active" value="1">
                  @endif
